...
{
	public static final Animation hop = Animation.Builder.create(0.8F)
												...
												.addBoneAnimation("splash", new Transformation(Transformation.Targets.SCALE,
														new Keyframe(0.0F, AnimationHelper.createScalingVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR)
												))
												.build();
	
	public static final Animation splash = Animation.Builder.create(0.95F)
												   .addBoneAnimation("bone", new Transformation(Transformation.Targets.SCALE,
														   new Keyframe(0.0F, AnimationHelper.createScalingVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR)
												   ))
												   .addBoneAnimation("splash", new Transformation(Transformation.Targets.TRANSLATE,
														   ...
														   new Keyframe(0.9F, AnimationHelper.createTranslationalVector(0.0F, -10.0F, 0.0F), Transformation.Interpolations.LINEAR)
												   ))
												   .addBoneAnimation("splash", new Transformation(Transformation.Targets.SCALE,
														   new Keyframe(0.0F, AnimationHelper.createScalingVector(0.3F, 0.4F, 0.3F), Transformation.Interpolations.LINEAR),
														   new Keyframe(0.1F, AnimationHelper.createScalingVector(0.9F, 1.3F, 0.9F), Transformation.Interpolations.LINEAR),
														   new Keyframe(0.4F, AnimationHelper.createScalingVector(1.1F, 1.0F, 1.1F), Transformation.Interpolations.LINEAR),
														   new Keyframe(0.95F, AnimationHelper.createScalingVector(1.2F, 1.0F, 1.2F), Transformation.Interpolations.LINEAR)
												   ))
												   .build();
}